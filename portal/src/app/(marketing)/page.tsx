      ...
      <section className="hero">
        <div className="container">
          ...
          <h1>
            ...
            <span className="gradient-text">every marketing platform</span>
          </h1>
          ...
          <div className="hero-buttons">
            ...
            <a href="https://github.com/elmandalorian-thx/MCP-Marketing" target="_blank" rel="noopener noreferrer" className="btn btn-secondary">
            ...
            <div className="code-window">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: `<span class="prompt">You:</span> Find keyword ideas for "organic coffee beans"<br><br><span class="response">Claude:</span> I'll search Google Ads Keyword Planner for you.<br><br><span class="comment">  Keyword                        Avg. Searches  Competition</span><br><span class="string">  organic coffee beans            22,200         High</span><br><span class="string">  best organic coffee              14,800         Medium</span><br><span class="string">  organic coffee subscription       6,600         Low</span><br><span class="string">  fair trade organic coffee         4,400         Medium</span><br><span class="string">  organic coffee brands             3,200         High</span><br>`,
                }}
              />
            </div>
          </div>
      ...
      <section id="how-it-works">
        <div className="container">
          <div className="section-header fade-in">
            ...
            <p className="section-subtitle">No SDKs, no wrappers, no boilerplate. Just connect and go.</p>
          </div>
      ...
      <section id="platforms" className="platforms-section">
        <div className="container">
          <div className="section-header fade-in">
            ...
            <h2 className="section-title">22 tools across every major platform</h2>
            <p className="section-subtitle">From search to social, ads to analytics. One server covers it all.</p>
          </div>
          <div className="platforms-grid fade-in">
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#4285f4,#34a853)" }}>G</div>
              <span>Google Ads</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#f9ab00,#e37400)" }}>GA</div>
              <span>GA4</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#4285f4,#0d652d)" }}>SC</div>
              <span>Search Console</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#1877f2,#0059b3)" }}>f</div>
              <span>Meta / Facebook</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#ff0000,#cc0000)" }}>YT</div>
              <span>YouTube</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#ff4500,#ff6634)" }}>R</div>
              <span>Reddit</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#4285f4,#1a73e8)" }}>GT</div>
              <span>Google Trends</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#4285f4,#0f9d58)" }}>BP</div>
              <span>Business Profile</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#0f9d58,#34a853)" }}>GD</div>
              <span>Google Drive</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#ff6c2c,#ff4500)" }}>SR</div>
              <span>SEMrush</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#0a66c2,#004182)" }}>in</div>
              <span>LinkedIn</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#008373,#00a68c)" }}>B</div>
              <span>Bing Webmaster</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#ffe01b,#241c15)" }}>MC</div>
              <span>Mailchimp</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#00f2ea,#ff0050)" }}>TT</div>
              <span>TikTok</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#e60023,#ad081b)" }}>P</div>
              <span>Pinterest</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#1da1f2,#0d8bd9)" }}>X</div>
              <span>X / Twitter</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#96bf48,#5e8e3e)" }}>S</div>
              <span>Shopify</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#af0606,#d32323)" }}>Y</div>
              <span>Yelp</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#ff7a59,#ff5c35)" }}>HS</div>
              <span>HubSpot</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#3eab49,#259634)" }}>BW</div>
              <span>BuiltWith</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "linear-gradient(135deg,#06b6d4,#0891b2)" }}>PS</div>
              <span>PageSpeed</span>
            </div>
            <div className="platform-card">
              <div className="platform-icon" style={{ background: "var(--gradient-main)" }}>+</div>
      ...
      <section id="setup" className="setup-section">
        <div className="container">
          <div className="section-header fade-in">
            ...
            <h2 className="section-title">Set up in 30 seconds</h2>
            <p className="section-subtitle">Pick your AI tool, paste the config, done.</p>
          </div>

          <div className="fade-in">
            <div className="setup-tabs" role="tablist">
              <button className="setup-tab active" onClick={(e) => { const el = e.currentTarget; document.querySelectorAll('.setup-tab').forEach(t => t.classList.remove('active')); document.querySelectorAll('.setup-panel').forEach(p => p.classList.remove('active')); el.classList.add('active'); document.getElementById('tab-claude-desktop')!.classList.add('active'); }} role="tab">Claude Desktop</button>
              <button className="setup-tab" onClick={(e) => { const el = e.currentTarget; document.querySelectorAll('.setup-tab').forEach(t => t.classList.remove('active')); document.querySelectorAll('.setup-panel').forEach(p => p.classList.remove('active')); el.classList.add('active'); document.getElementById('tab-claude-code')!.classList.add('active'); }} role="tab">Claude Code</button>
              <button className="setup-tab" onClick={(e) => { const el = e.currentTarget; document.querySelectorAll('.setup-tab').forEach(t => t.classList.remove('active')); document.querySelectorAll('.setup-panel').forEach(p => p.classList.remove('active')); el.classList.add('active'); document.getElementById('tab-openai')!.classList.add('active'); }} role="tab">OpenAI / GPT</button>
              <button className="setup-tab" onClick={(e) => { const el = e.currentTarget; document.querySelectorAll('.setup-tab').forEach(t => t.classList.remove('active')); document.querySelectorAll('.setup-panel').forEach(p => p.classList.remove('active')); el.classList.add('active'); document.getElementById('tab-other')!.classList.add('active'); }} role="tab">Gemini / Other</button>
            </div>

            <div className="setup-content">
              {/* Claude Desktop */}
              <div className="setup-panel active" id="tab-claude-desktop">
                ...
                <div className="setup-code" id="code-claude-desktop">
                  <button className="copy-btn" onClick={() => { const el = document.getElementById('code-claude-desktop')!; const btn = el.querySelector('.copy-btn') as HTMLButtonElement; const text = el.textContent!.replace('Copy', '').trim(); navigator.clipboard.writeText(text).then(() => { btn.textContent = 'Copied!'; btn.classList.add('copied'); setTimeout(() => { btn.textContent = 'Copy'; btn.classList.remove('copied'); }, 2000); }); }}>Copy</button>
                  <span dangerouslySetInnerHTML={{ __html: `<span style="color:#cba6f7">{</span>\n  <span style="color:#89b4fa">"mcpServers"</span>: <span style="color:#cba6f7">{</span>\n    <span style="color:#89b4fa">"marketing"</span>: <span style="color:#cba6f7">{</span>\n      <span style="color:#89b4fa">"url"</span>: <span style="color:#a6e3a1">"https://marketingmcp.statika.net/mcp"</span>\n    <span style="color:#cba6f7">}</span>\n  <span style="color:#cba6f7">}</span>\n<span style="color:#cba6f7">}</span>` }} />
                </div>
              ...
              {/* Claude Code */}
              <div className="setup-panel" id="tab-claude-code">
                <h4>Claude Code (CLI)</h4>
                <p>Run this single command in your terminal:</p>
                <div className="setup-code" id="code-claude-code">
                  <button className="copy-btn" onClick={() => { const el = document.getElementById('code-claude-code')!; const btn = el.querySelector('.copy-btn') as HTMLButtonElement; const text = el.textContent!.replace('Copy', '').trim(); navigator.clipboard.writeText(text).then(() => { btn.textContent = 'Copied!'; btn.classList.add('copied'); setTimeout(() => { btn.textContent = 'Copy'; btn.classList.remove('copied'); }, 2000); }); }}>Copy</button>
                  <span dangerouslySetInnerHTML={{ __html: `<span style="color:#a6e3a1">claude mcp add marketing https://marketingmcp.statika.net/mcp</span>` }} />
                </div>
                <div className="setup-note">
              ...
              {/* Gemini / Other */}
              <div className="setup-panel" id="tab-other">
                <h4>Gemini / Any MCP Client</h4>
                <p>Marketing MCP works with any MCP-compatible client:</p>
                <div className="setup-code" id="code-other">
                  <button className="copy-btn" onClick={() => { const el = document.getElementById('code-other')!; const btn = el.querySelector('.copy-btn') as HTMLButtonElement; const text = el.textContent!.replace('Copy', '').trim(); navigator.clipboard.writeText(text).then(() => { btn.textContent = 'Copied!'; btn.classList.add('copied'); setTimeout(() => { btn.textContent = 'Copy'; btn.classList.remove('copied'); }, 2000); }); }}>Copy</button>
                  <span dangerouslySetInnerHTML={{ __html: `<span style="color:#6c7086"># Endpoint</span>\n<span style="color:#a6e3a1">https://marketingmcp.statika.net/mcp</span>\n\n<span style="color:#6c7086"># Protocol: MCP (Streamable HTTP)</span>\n<span style="color:#6c7086"># Tools: 22 marketing tools auto-discovered</span>` }} />
                </div>
                <div className="setup-note">
      ...
      <section id="tools" className="tools-section">
        <div className="container">
          <div className="section-header fade-in">
            ...
            <h2 className="section-title">Just ask. Your AI handles the rest.</h2>
            <p className="section-subtitle">Real prompts, real tools, real marketing data.</p>
          </div>
          <div className="tools-grid fade-in">
            <div className="tool-card">
              <div className="tool-prompt"><span className="q">&ldquo;</span> Find keyword ideas for &apos;vegan protein powder&apos;</div>
              <div className="tool-meta">
                <span className="tool-name">gads_keyword_ideas</span>
                <span className="tool-api">Google Ads API</span>
              </div>
            </div>
            <div className="tool-card">
              <div className="tool-prompt"><span className="q">&ldquo;</span> Show my top search queries this month</div>
              <div className="tool-meta">
                <span className="tool-name">gsc_search_queries</span>
                <span className="tool-api">Search Console</span>
              </div>
            </div>
            <div className="tool-card">
              <div className="tool-prompt"><span className="q">&ldquo;</span> What&apos;s the audience size for &apos;fitness&apos; on Meta?</div>
              <div className="tool-meta">
                <span className="tool-name">meta_interest_targeting</span>
                <span className="tool-api">Meta Graph API</span>
              </div>
            </div>
            <div className="tool-card">
              <div className="tool-prompt"><span className="q">&ldquo;</span> Audit the speed of example.com</div>
              <div className="tool-meta">
                <span className="tool-name">pagespeed_audit</span>
                <span className="tool-api">PageSpeed Insights</span>
              </div>
            </div>
            <div className="tool-card">
              <div className="tool-prompt"><span className="q">&ldquo;</span> What&apos;s trending on Reddit about AI startups?</div>
              <div className="tool-meta">
                <span className="tool-name">reddit_topic_research</span>
                <span className="tool-api">Reddit / PRAW</span>
              </div>
            </div>
            <div className="tool-card">
              <div className="tool-prompt"><span className="q">&ldquo;</span> Show my organic traffic performance in GA4</div>
              <div className="tool-meta">
                <span className="tool-name">ga4_organic_performance</span>
                <span className="tool-api">GA4 Data API</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="pricing-section">
        <div className="container">
          <div className="section-header fade-in">
            ...
            <p className="section-subtitle">No credit card required. Upgrade anytime.</p>
          </div>
          <div className="pricing-grid fade-in">
            ...
            <div className="pricing-card">
              ...
              <div className="pricing-desc">For individuals exploring</div>
              <ul className="pricing-features">
                <li><span className="check">&#10003;</span> 1 seat</li>
                <li><span className="check">&#10003;</span> 3 connections</li>
                <li><span className="check">&#10003;</span> 500 calls/month</li>
                <li><span className="check">&#10003;</span> All 22 tools</li>
            ...
            <div className="pricing-card">
              ...
              <div className="pricing-desc">For small teams</div>
              <ul className="pricing-features">
                <li><span className="check">&#10003;</span> 3 seats</li>
                <li><span className="check">&#10003;</span> 10 connections</li>
                <li><span className="check">&#10003;</span> 5,000 calls/month</li>
                <li><span className="check">&#10003;</span> All 22 tools</li>
            ...
            <div className="pricing-card featured">
              ...
              <div className="pricing-desc">For agencies</div>
              <ul className="pricing-features">
                <li><span className="check">&#10003;</span> 10 seats</li>
                <li><span className="check">&#10003;</span> 50 connections</li>
                <li><span className="check">&#10003;</span> 50,000 calls/month</li>
                <li><span className="check">&#10003;</span> All 22 tools</li>
                <li><span className="check">&#10003;</span> Priority support</li>
                <li><span className="check">&#10003;</span> Usage analytics</li>
              </ul>
              <a href="/signup" className="pricing-btn">Get Started</a>
            </div>
            {/* Enterprise */}
            <div className="pricing-card">
              ...
              <ul className="pricing-features">
                ...
                <li><span className="check">&#10003;</span> Unlimited connections</li>
                <li><span className="check">&#10003;</span> Unlimited calls</li>
                <li><span className="check">&#10003;</span> All 22 tools</li>
              ...
              <a href="mailto:hello@statika.net" className="pricing-btn">Contact Sales</a>
            </div>
          </div>
        </div>
      </section>
